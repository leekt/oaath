...
const testFiles = [
  ...
  "ecdsa-permission-signer.test.ts",
...
try {
  const dependencies = {
    ...
    "@noble/curves": await installedVersion("@noble/curves"),
    "@types/node": await installedVersion("@types/node"),
    "@zerodev/ecdsa-validator": await installedVersion("@zerodev/ecdsa-validator"),
    "@zerodev/passkey-validator": await installedVersion("@zerodev/passkey-validator"),
    "@zerodev/permissions": await installedVersion("@zerodev/permissions"),
    "@zerodev/sdk": await installedVersion("@zerodev/sdk"),
    "@zerodev/webauthn-key": await installedVersion("@zerodev/webauthn-key"),
