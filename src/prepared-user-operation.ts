...
export const OGP_PREPARED_USER_OPERATION_VERSION = "ogp.prepared-user-operation/v1" as const;
...
export interface PreparedUserOperation {
  readonly version: typeof OGP_PREPARED_USER_OPERATION_VERSION;
...
function invalid(code: PreparedUserOperationErrorCode, message: string): never {
  throw new OgpPreparedUserOperationError(code, message);
}
...
function parsePreparedUserOperationUnsafe(
  ...
  if (record.version !== OGP_PREPARED_USER_OPERATION_VERSION) {
  ...
  return Object.freeze({
    version: OGP_PREPARED_USER_OPERATION_VERSION,
    ...preparation,
...
export function prepareUserOperation(value: unknown): PreparedUserOperation {
  ...
  try {
    ...
    throw new OgpPreparedUserOperationError(
      code,
