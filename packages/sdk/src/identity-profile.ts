...
export const OAATH_OWNER_CREDENTIAL_PROFILE_VERSION = "oaath.owner-credential-profile/v1" as const;
...
export interface EcdsaOwnerCredentialProfile {
  readonly version: typeof OAATH_OWNER_CREDENTIAL_PROFILE_VERSION;
  readonly kind: "ecdsa";
...
export interface EcdsaOperatorCredentialProfile {
  readonly version: typeof OAATH_OPERATOR_CREDENTIAL_PROFILE_VERSION;
  readonly kind: "ecdsa";
  readonly address: `0x${string}`;
}
...
function captureOwnerCredential(
  ...
  if (record.version !== OAATH_OWNER_CREDENTIAL_PROFILE_VERSION) {
...
function captureOperatorCredential(
  ...
  if (record.version !== OAATH_OPERATOR_CREDENTIAL_PROFILE_VERSION) {
